...
{% endcomment %}
- [Settings](index.md#preferences) メニューから Docker Desktop の設定を行うことができます。
...
{% endcomment %}
![サンプル投票アプリのアーキテクチャー構成図](../docker-for-windows/images/example-app-architecture.png){:width="600px"}
