...
{% endcomment %}
ここでは Docker Engine において一般的に利用可能な Docker Engine プラグインについて説明します。
Docker によって管理されるプラグインの各種情報については、[Docker Engine プラグインシステム](index.md) を参照してください。
...
{% endcomment %}
Docker プラグインの構築に興味のある方、あるいはどのようにして動作しているかを見たい方は、[Docker プラグインリファレンス](plugin_api.md) を参照してください。
